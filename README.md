...
| Module 07 | Data Visualization | In progress |
...
| **Week 7** | Expanded into full-spectrum Data Visualization and Storytelling. Engineered reproducible slide decks using HTML (`Reveal.js`) and Markdown (`Marp`), and explored reactive Python notebooks with `Marimo`. Programmed statistical static charts via `Seaborn`, built complex network relationship maps via Kumu, and created time-based animated visual narratives using Flourish. Leveraged AI/LLMs for automated chart generation and narrative data synthesis. |
